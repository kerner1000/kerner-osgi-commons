...
//			"/home/alex/Dropbox/mpiz/thal/test.fas");
	...
	private final static File f2 = new File(
			"/home/alex/Dropbox/mpiz/thal/new.fas");

	private final static File f3 = new File(
			"/home/alex/Dropbox/mpiz/thal/test3.gff");
...
//	"/home/alex/Dropbox/mpiz/thal/TAIR9_GFF3_chr1.gff");
	...
	public static void main(String[] args) {
		...
		info("creating Union");
		final GFF3FASTAUnion union = new GFF3FASTAUnionImpl(gff3File, fastaFile);
		...
		// debug("gff3 after trimming:" + Utils.NEW_LINE + unionTrimmed.getGFF3ElementGroup());
		info("running union integrity test");
