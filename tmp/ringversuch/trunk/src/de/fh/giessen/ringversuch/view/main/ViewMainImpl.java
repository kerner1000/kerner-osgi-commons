...
import de.fh.giessen.ringversuch.view.CentralViewService;
import de.fh.giessen.ringversuch.view.ViewOut;

public class ViewMainImpl extends JPanel implements ViewMain {
	...
	private final class MyListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == buttonSelect) {
				final int returnVal = fileChooserinputFiles.showOpenDialog(central.getMainComponent());
				if (returnVal == JFileChooser.APPROVE_OPTION) {
					areaFiles.setText("");
					files.clear();
					final File[] inputFiles = fileChooserinputFiles.getSelectedFiles();
					if(viewOut.setSelectedFiles(inputFiles)){
				...
				final int returnVal = fileChooseroutDir.showSaveDialog(central.getMainComponent());
				if (returnVal == JFileChooser.APPROVE_OPTION) {
					viewOut.setOutDir(fileChooseroutDir.getSelectedFile());
		...
		private void showAbout() {
			...
			javax.swing.SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					JOptionPane.showMessageDialog(central.getMainComponent(), Preferences.NAME + " Version " + Preferences.VERSION+"\n"
	...
	final static Logger LOGGER = Logger.getLogger(ViewMainImpl.class);
	...
	public ViewMainImpl(ViewOut viewOut, CentralViewService central) {
