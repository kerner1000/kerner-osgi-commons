 ...
 * 
 */
public class ViewSettingsImpl extends JPanel implements ViewSettings {
	...
	private final class MyListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == buttonUse) {
				if (viewOut.setSettings_controller(getSettings()))
					central.hideSettingsView();

			} else if (e.getSource() == buttonSave) {
				if (viewOut.saveSettings(getSettings())) {
				...
				if (returnVal == JFileChooser.APPROVE_OPTION) {
					...
					if (viewOut.loadSettings(file)) {
						setSettings(central.getSettings());
						// its a question of taste if we close the window after
						// setting or not
						// controller.hideSettingsView();
					}
	...
	private final static Logger LOGGER = Logger
			.getLogger(ViewSettingsImpl.class);
	...
	public ViewSettingsImpl(ViewOut viewOut, CentralViewService central) {
	...
	private void setSettings(ViewTypeSettings settings) {
	...
	private ViewTypeSettings getSettings() {
